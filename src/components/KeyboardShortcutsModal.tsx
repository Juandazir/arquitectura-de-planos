  ...
  const sections: { title: string; color: string; items: ShortcutItem[] }[] = [
    {
      ...
      items: [
        ...
        { keys: ['R'], label: 'Rotar 90° Elemento', description: 'Gira 90 grados el mueble o artefacto seleccionado al instante', icon: <RotateCw className="w-4 h-4 text-emerald-400" /> },
